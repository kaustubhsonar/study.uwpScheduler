...
namespace SchedularApp
{
    public partial class MainPage : Page
    {
        ...
        {
            new Scenario() { Title="Background Task", ClassType=typeof(MainPage)},
            new Scenario() { Title="Background Task with Condition", ClassType=typeof(MainPage)},
            new Scenario() { Title="Servicing Complete Task", ClassType=typeof(MainPage)},
            new Scenario() { Title="Background Task with Time Trigger", ClassType=typeof(MainPage) },
            new Scenario() { Title="Background Task with Application Trigger", ClassType=typeof(MainPage) },
            new Scenario() { Title="Grouped Background Task", ClassType=typeof(MainPage) },
        };
    }
